...
public class Register extends AppCompatActivity {
    ...
    EditText mEmail,mPassword,mUsername,mPhone,maadhaar;
    Button mSignupbtn;
    TextView mloginbtn;
    ProgressBar pbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maadhaar=(EditText)findViewById(R.id.aadhaar);
        ...
        mSignupbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (aadhaar.isEmpty()) {
                    maadhaar.setError("Aadhaar Number is Required");
                    maadhaar.requestFocus();
                    return;
                }
